...
<tbody>
  ...
  <tr>
    <td>13:45</td>
    <td>
		<strong>[GRAD] Ensino de Engenharia de Software utilizando Sala de Aula Invertida</strong><br>
		<i>Autor: Plinio Vilela (Universidade de Campinas)</i>
	</td>
  </tr>
  <tr>
    <td>14:00</td>
    <td>
		<strong>[GRAD] Avaliação de um Software para o Ensino de Gerenciamento de Projetos com base no PMBOK: Um Grupo Focal</strong><br>
		<i>Autores: Raul Neves (Unipampa), Dionas Muller (Unipampa), Maicon Bernardino (Unipampa), Thiago Araújo (Unipampa), Matheus Boeira (Unipampa), Elder Rodrigues (Unipampa)</i>
	</td>
  </tr>
  ...
  <tr>
    <td>14:15</td>
    <td>
		<strong>[GRAD] Integração de atividades de programação no ensino de teste de software em um ambiente com elementos de jogos</strong><br>
		<i>Autores: Vinicius Petris (UTFPR), Marco Aurélio Graciotto Silva (UTFPR)</i>
	</td>
  </tr>
  ...
  <tr>
    <td>14:30</td>
    <td>
		<strong>[POS] Gamificação no Ensino de Engenharia de Software: Guidelines para Apoio ao Professor</strong><br>
		<i>Autores: Julio Herculani (UEM), Aline Amaral (UEM), Thelma Colanzi (UEM)</i> 
	</td>
  </tr>
...
<thead>
  <tr>
    <th colspan="2"><strong>Sessão Técnica 6 - Aspectos Gerais de Engenharia de Software</strong><br><i>Chair: Edna Dias Canedo</i></th>
  </tr>
</thead>
<tbody>
  <tr>
