...
<div class="minicurso">
  <h2 class="minicurso-title">Minicurso: Introdução à Detecção de Intrusões com Machine Learning: Protegendo Redes com Inteligência Artificial Explicável</h2>
...
<div class="minicurso">
  <h2 class="minicurso-title">Minicurso: Risco em Jogo – Aprendendo Gerenciamento de Riscos de Forma Divertida</h2>
  <p class="minicurso-resumo">
...
<div class="minicurso">
  <h2 class="minicurso-title">Minicurso: Filament PHP: Acelerando o Desenvolvimento com Laravel</h2>
  <p class="minicurso-resumo">
